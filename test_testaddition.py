...
class Testaddition:
    ...
    def Setup(self):
        Testaddition.driver = webdriver.Chrome(
            executable_path="E:\\JenkinsTrainingNSDL\\pytest-main\\Driver\\chromedriver.exe")
        Testaddition.driver.get("file://E:/JenkinsTrainingNSDL/pytest-main/src/main/webapp/Calculator.html")
